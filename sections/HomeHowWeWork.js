        ...
        <div css={tw`flex justify-between items-start`}>
          <div css={tw`w-4/12`}>
            <Title after={true}  tag="h2">
              How We <TitleSpan after="k" styles={tw`after:right-[-28px] after:bottom-[15px] after:w-[26px] after:h-[10px]` }> Work</TitleSpan>
            </Title>
              ...
              {workTypes.map((w,i)=>{
                return (
                  <li key={i} css={tw`py-1 flex items-center`}>
                    ...
                    <p css={tw`inline-block text-xl text-transparent bg-clip-text bg-gradient-to-r from-brand-purple via-brand-blue to-brand-turquoise font-medium`}>
                      {w}
                    </p>
                  </li>
                )
