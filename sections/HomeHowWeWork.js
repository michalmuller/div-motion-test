        ...
        <div css={tw`flex flex-col sm:flex-row justify-between items-start`}>
          <div css={tw`w-full sm:w-4/12`}>
            <Title after={true}  tag="h2">
              How We <TitleSpan after="k" styles={tw`after:right-[-28px] after:bottom-[10px] sm:after:bottom-[15px] after:w-[26px] after:h-[10px]` }> Work</TitleSpan>
            </Title>
            ...
            <ul css={tw`mt-8`}>
              {workTypes.map((w,i)=>{
                return (
                  <li key={i} css={tw`py-1 flex items-center`}>
                    <svg css={tw`mr-3 sm:mr-5`} width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p css={tw`inline-block text-lg sm:text-xl text-transparent bg-clip-text bg-gradient-to-r from-brand-purple via-brand-blue to-brand-turquoise font-medium`}>
                      {w}
                    </p>
                  </li>
                )
          ...
          <div css={tw`w-full sm:w-7/12 mt-10 sm:mt-0`}>
